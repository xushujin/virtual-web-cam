...
- [简明部署文档](docs/简明部署文档.md)
- [详细部署文档](docs/详细部署文档.md)
- [开发技术文档](docs/开发技术文档.md)
- [部署运维文档](docs/部署运维文档.md)
- [用户使用指南](docs/用户使用指南.md)

对应 HTML 版本可直接用浏览器打开：

- [简明部署文档 HTML](docs/简明部署文档.html)
- [详细部署文档 HTML](docs/详细部署文档.html)
- [开发技术文档 HTML](docs/开发技术文档.html)
- [部署运维文档 HTML](docs/部署运维文档.html)
- [用户使用指南 HTML](docs/用户使用指南.html)
...
- 文档正文默认使用中文。
- 交付文档文件名默认使用中文。
- 代码注释默认使用中文；工具指令类注释按工具要求保留原格式，例如 `shellcheck disable`。
